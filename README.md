...
>
> **GitHub token:** Create a Personal Access Token at GitHub Settings → Developer settings → Personal access tokens (fine-grained, read access to your repo) so the agent can fetch your latest commits and issues. Images are generated by [Pollinations.ai](https://pollinations.ai) (free, no key required).
